...
void Server::Init_Serveur(int port, std::string pass)
{
...
/*Gerer les connections entraintes sur sock_fd du serv et crée des new socket pour chaque connexion*/
...
void Server::handleData(int fd)
{
    ...
    else
    {
        ...
        {
            std::cout << RESET << command[i] << std::endl;
