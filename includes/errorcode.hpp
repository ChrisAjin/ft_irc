...
#define ERR_PASSWORDINCORRECT(client) (": 464 " + client + " :Password incorrect\r\n")
...
#define ERR_NOTOPLEVEL(mask) (": 413 " + mask + " :No top-level domain specified\r\n")
